...
SECRET_KEY = 'django-insecure-+@x*0scay%@0@8#_@ij50&dvv-gixw^(kr)55nwhj)atg$$0l*'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '11337799Eb',           # Contraseña del usuario
...
#cuando exista un error o pase la bongos
